...
and dump_at_rule ppf (ar: Ppx_bs_css.Css_types.At_rule.t) =
  ...
  Fmt.fmt "%a %a %a" ppf pp_name ar.Ppx_bs_css.Css_types.At_rule.name
    ...
    ar.Ppx_bs_css.Css_types.At_rule.block
...
let dump_declaration ppf (d: Ppx_bs_css.Css_types.Declaration.t) =
  ...
  let pp_important =
    ...
    | false -> Fmt.nop
    | true -> Fmt.(const string " !important")
  in
  Fmt.fmt "%a: %a%a" ppf pp_name d.Ppx_bs_css.Css_types.Declaration.name
    pp_values d.Ppx_bs_css.Css_types.Declaration.value pp_important ()
...
let dump_declaration_list ppf (dl: Ppx_bs_css.Css_types.Declaration_list.t) =
  let pp_elem ppf d =
    ...
    | Ppx_bs_css.Css_types.Declaration_list.Declaration d ->
